...
/**
 * funzione che effettua lo scambio dei valori tra due vettori
 ...
 * @param int dim
 */
void sommaComponentiPari(int vett[], int dim);

/**
 * funzione che fa la somma dei componenti di indice dispari di un vettore
 * @param int[]vettore in ingresso
 * @param int dim
 */
